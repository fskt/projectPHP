        ...
        <div id="page_content_inner">
            <div class="md-card">
                <div class="md-card-content">
					...
					if(count($query)>0){
						foreach($query as $v){
							$date_created = date('d M Y',strtotime($v['date_created']));
							$date_updated = date('d M Y H:i:s',strtotime($v['date_updated']));
							$date_range = explode('[SPLIT]',$v['date_range']);
							$date1 = date('d M Y',strtotime($date_range[0]));
							$date2 = date('d M Y',strtotime($date_range[1]));
							$date  = $date1.' until '.$date2;
							$instagram_image = $v['instagram_image'];
							$instagram_title = $v['instagram_title'];
							$youtube_image = $v['youtube_image'];
							...
							echo '
							<img src="'.($type=='instagram'?$instagram_image:$youtube_image).'" width=250><br/>
							date created : '.$date_created.'<br/>
							date last updated : '.$date_updated.'<br/>
							date range : '.$date.' ('.$status.')<br/>
							assign to : '.$name.'<br/>
							';
