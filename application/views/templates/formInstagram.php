        ...
        <div id="page_content_inner">
            <div class="md-card">
                <div class="md-card-content">
                    <?php echo $message?>
					<form method="post" action="<?php echo base_url()?>post_instagram.html" enctype="multipart/form-data">
					Caption : <input type="text" name="caption">
					Upload File : <input id="form-file" name="upload_file" type="file">					
					<div class="uk-grid" data-uk-grid-margin>
						<div class="uk-width-large-1-3 uk-width-medium-1-1">
							<div class="uk-input-group">
								<span class="uk-input-group-addon"><i class="uk-input-group-icon uk-icon-calendar"></i></span>
								<label for="uk_dp_start">Set Date Post</label>
								<input class="md-input" name="date_post" type="text" id="uk_dp_start" required>
							</div>
						</div>
					</div>
					<input type="submit" name="submit" value="POST INSTAGRAM">
					</form>
                </div>
            </div>
        </div>
