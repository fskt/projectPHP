                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Voluptatem repellendus.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Sint in explicabo rerum quia repellat dignissimos.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Quia delectus esse.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Eum aut qui repellat dicta dolores dignissimos nihil neque et dolorem.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-light-green">gn</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Similique non.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Autem aspernatur consequatur sed placeat est atque.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Earum magnam.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Tenetur adipisci qui porro quaerat qui ea officia id commodi mollitia.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Omnis cupiditate perferendis.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Corporis aperiam consequatur veniam id corrupti culpa et deleniti iste in.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Ea saepe aut.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Quibusdam explicabo accusantium ut enim dolorem in.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Veniam minus est.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Saepe esse est odio.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Dicta non.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Magni officiis repellendus vero aliquam voluptatem quidem.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Rerum voluptates occaecati.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Nesciunt ipsum unde dolorum atque et.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
    ...
    <aside id="sidebar_main">
        ...
        <div class="sidebar_main_header">
            <div class="sidebar_logo">
                <a href="index.html" class="sSidebar_hide" style="margin-left:14px;"><img src="<?php echo base_url()?>assets/img/logo_main.png" alt="" height="45" width="200"/></a>
                    ...
                    <div class="md-card">
                        <div class="md-card-head md-bg-light-blue-600">
                            ...
                            <div class="uk-text-center">
                                <img class="md-card-head-avatar" src="'.$profile_picture.'" alt=""/>
                            </div>
                            <h3 class="md-card-head-text uk-text-center md-color-white">
                                <a href="'.base_url().'user/'.$username.'/youtube">'.$name.'</a>
                            </h3>
                        </div>
                        <div class="md-card-content">
                            <ul class="md-list md-list-addon">
                                <li style="margin-left: 10px;">
                                    <div class="md-list-content">
                                        <span class="md-list-heading" style="font-weight: 100;">'.$bio.'</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="md-list-addon-element">
                                    ...
                                    <div class="md-list-content">
                                        ...
                                        <span class="uk-text-small uk-text-muted">Subscribers</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="md-list-addon-element">
                                    ...
                                    <div class="md-list-content">
                                        <span class="md-list-heading">'.$followed_by.'</span>
                                        <span class="uk-text-small uk-text-muted">Followers</span>
                                    </div>
                                </li>
								<li>
                                    <div class="md-list-addon-element">
                                        <i class="md-list-addon-icon uk-icon-tasks"></i>
                                    </div>
                                    <div class="md-list-content">
                                        <span class="md-list-heading">'.$media.'</span>
                                        <span class="uk-text-small uk-text-muted">Contents</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <ul class="md-list md-list-addon chat_users">
                        ...
                        <li>
                            <div class="md-list-addon-element">
                                ...
                                <img class="md-user-image md-list-addon-avatar" src="<?php echo base_url()?>assets/img/avatars/avatar_04_tn.png" alt=""/>
                            </div>
                            <div class="md-list-content">
                                <div class="md-list-action-placeholder"></div>
                        ...
                        <div class="chat_box chat_box_colors_a">
                            <div class="chat_message_wrapper">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="<?php echo base_url()?>assets/img/avatars/avatar_11_tn.png" alt=""/>
                                </div>
                            ...
                            <div class="chat_message_wrapper chat_message_right">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="<?php echo base_url()?>assets/img/avatars/avatar_03_tn.png" alt=""/>
                                </div>
                                <ul class="chat_message">
                                    <li>
                                        <p>
