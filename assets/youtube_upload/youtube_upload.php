...
if(isset($_POST['videoSubmit'])){
	...
	if($_FILES["videoFile"]["name"] != ''){
		...
		$allowedTypeArr = array("mp4", "avi", "mpeg", "mpg", "mov", "wmv", "rm");
...
if ($client->getAccessToken()) {
  try{
	...
	/* setelah proses upload beres, delete file yang ada di server kita  (optional) */
